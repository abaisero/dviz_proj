...
(function (exports) {
    ...
    function Species(properties) {
        if (properties) {
            this._code           = capitalize(properties.code);
            this._speciesName    = capitalize(properties.species);
            this._genusName      = capitalize(properties.genus);
            this._familyName     = capitalize(properties.family);
            this._scientificName = capitalize(properties.scientificName);
            this._commonName     = capitalize(properties.commonName);
    ...
    Genus.prototype.type = function() { return 'genus'; };
    ...
    // Instance methods
    // `init` can inherit from the Species method
    Family.prototype.type = function() { return 'family'; };
